...
import { Terminal, Cloud, Server, Github, Linkedin, Mail } from "lucide-react";
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/80 border border-primary/30 mb-8"
          >
            <span className="w-2 h-2 rounded-full bg-success animate-pulse" />
            <span className="text-sm font-mono text-foreground">AWS Certified Solutions Architect – Associate</span>
          </motion.div>
